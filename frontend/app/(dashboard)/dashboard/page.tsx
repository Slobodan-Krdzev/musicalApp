...
import { RevenueAnalyticsModal } from '@/components/dashboard/RevenueAnalytics';
import {
  openBillingPortal,
  fetchInvoices,
  cancelSubscription,
        ...
        <div className="border-t border-zinc-800 pt-4">
          ...
          {editing ? (
            <div className="space-y-2 mt-1.5">
              <PhoneInputField
                label={isMusician ? 'Phone' : 'Contact phone'}
              ...
              {!isMusician && (
                <PhoneInputField
                  ...
                  onChange={(value) => updateDraft('reservationPhone', value)}
            ...
            <>
              ...
              {isMusician && current.socialLinks?.spotify && <InfoRow label="Spotify" value={current.socialLinks.spotify} />}
            </>
          )}
        </div>
      </CardContent>
